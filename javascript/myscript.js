...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Ấn vào đây " ;
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Lêu lêu bị lừa òi, ấn vào tên bé kìa ^.^';
document.querySelector('.Description .modal-body').innerHTML = 'Nhìn dòng trên<i class="fas fa-heart"></i> ';
